...
if (
    ...
    try {
        ...
        $sql_libro = "
            INSERT INTO Libros (titulo, isbn, fecha_publicacion, unidades, disponible, autor_id, genero_id)
            VALUES (:titulo, :isbn, :fecha_publicacion, :unidades, 1, :autor_id, :genero_id)
        ";
